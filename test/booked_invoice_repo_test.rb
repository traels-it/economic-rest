...
class BookedInvoiceRepoTest < Minitest::Test
  describe "#save" do
    ...
    it "books a draft invoice" do
      ...
      booked_invoice = Economic::Invoices::BookedRepo.save(Economic::Invoice.new)
    ...
    it "can book an invoice with a specific supplied number" do
      ...
      booked_invoice = Economic::Invoices::BookedRepo.save(Economic::Invoice.new, book_with_number: 9999999)
