    ...
    class BookedTest < Minitest::Test
      describe Economic::Repos::Invoices::Booked do
        ...
        describe "#create" do
          ...
          it "is possible to supply number that invoices should be booked under" do
            stub_request(:post, "https://restapi.e-conomic.com/invoices/booked")
              .with(
                body: {draftInvoice: {draftInvoiceNumber: 142}, sendBy: "ean", bookWithNumber: 38}
              ).to_return(status: 201, body: File.read(json_fixture("create_booked_invoice_with_ean")), headers: {})
            ...
            created_invoice = Economic::Repos::Invoices::Booked.new.create(booked_invoice, send_by: :ean, book_with_number: 38)
