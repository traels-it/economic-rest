  ...
  describe 'customer object' do
    ...
    it 'makes a new customer that is reloaded from economics after saving' do
      stub_request(:post, "https://restapi.e-conomic.com/customers/")
        .with(body: "{\"currency\":\"DKK\",\"paymentTerms\":{\"paymentTermsNumber\":5,\"payment_terms_number\":5},\"customerGroup\":{\"customerGroupNumber\":1,\"customer_group_number\":1},\"name\":\"Horsens Kommune\",\"vatZone\":{\"vatZoneNumber\":1,\"vat_zone_number\":1},\"currency\":\"DKK\",\"name\":\"Horsens Kommune\"}")
