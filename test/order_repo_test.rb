...
class OrderRepoTest < Minitest::Test
  describe "For order" do
    ...
    it "pulls a sent order back to draft and back to sent" do
      ...
      stub_request(:post, "https://restapi.e-conomic.com/orders/drafts").with(body: {"attachment": "https://restapi.e-conomic.com/orders/sent/15/attachment", "costPriceInBaseCurrency": 50.03, "currency": "DKK", "date": "2017-01-13", "dueDate": "2017-03-02", "exchangeRate": 100.0, "grossAmount": 875.0, "grossAmountInBaseCurrency": 875.0, "marginInBaseCurrency": 649.97, "marginPercentage": 92.85, "netAmount": 700.0, "netAmountInBaseCurrency": 700.0, "orderNumber": 15, "roundingAmount": 0.0, "vatAmount": 175.0, "customer": {"customerNumber": 10001}, "lines": [{"lineNumber": 1, "description": "Sidespejl (Sæt) Karma", "sortKey": 1, "quantity": 1.0, "unitNetPrice": 250.0, "discountPercentage": 0.0, "unitCostPrice": 50.03, "marginInBaseCurrency": 199.97, "marginPercentage": 79.99, "totalNetAmount": 250.0, "product": {"productNumber": "100082"}, "departmentalDistribution": {"distributions": []}}, {"lineNumber": 2, "description": "Øvre Stokkeholder Mc", "sortKey": 2, "quantity": 1.0, "unitNetPrice": 450.0, "discountPercentage": 0.0, "unitCostPrice": 0.0, "marginInBaseCurrency": 450.0, "marginPercentage": 100.0, "totalNetAmount": 450.0, "product": {"productNumber": "67"}, "departmentalDistribution": {"distributions": []}}], "paymentTerms": {"paymentTermsNumber": 2}, "recipient": {"name": "Æblegrød", "vatZone": {"vatZoneNumber": 1}}, "layout": {"layoutNumber": 16}}).to_return(status: 200, body: "", headers: {})
